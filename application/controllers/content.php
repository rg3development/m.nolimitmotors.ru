...
class Content extends MY_Controller {
    ...
    public function  __construct() {
        ...
        $this->_modx_polls_answers_url = 'http://nolimitmotors.ru/nlmotors/gfx/xml/modx_site_content.xml';
        $this->_modx_ph_url            = 'http://nolimitmotors.ru/nlmotors/gfx/xml/modx_site_tmplvar_contentvalues.xml';
        $this->_modx_gal_albums        = 'http://nolimitmotors.ru/nlmotors/gfx/xml/modx_gallery_albums.xml';
        $this->_modx_gal_items         = 'http://nolimitmotors.ru/nlmotors/gfx/xml/modx_gallery_items.xml';
        $this->_modx_gal_albims_items  = 'http://nolimitmotors.ru/nlmotors/gfx/xml/modx_gallery_album_items.xml';
    }
    ...
    public function xml()
    {
        echo "\n$this->_modx_polls_answers_url\n";
        $this->diff_func_mapper->get_catalog_xml($this->_modx_polls_answers_url);
        echo "\nDONE\n";
        echo "\n$this->_modx_ph_url\n";
        $this->diff_func_mapper->get_ph_xml($this->_modx_ph_url);
        echo "\nDONE\n";
        echo "\n$this->_modx_gal_albums\n";
        $this->diff_func_mapper->get_gal_albums_xml($this->_modx_gal_albums);
        echo "\nDONE\n";
        echo "\n$this->_modx_gal_items\n";
        $this->diff_func_mapper->get_gal_items_xml($this->_modx_gal_items);
        echo "\nDONE\n";
        echo "\n$this->_modx_gal_albims_items\n";
        $this->diff_func_mapper->get_gal_album_items_xml($this->_modx_gal_albims_items);
        echo "\nDONE\n";
    }
