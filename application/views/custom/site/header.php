...
<head>
    ...
    <link href='/www_site/css/mainSlider.css' rel='stylesheet' type='text/css'>
    ...
    <div id="wrap">
        ...
        <div class="page">
            ...
            <header class="header">
                ...
                <? endif; ?>
                <nav class="menu_sub yellow_btn">
                    <ul>
                        <li><a href="/<? if(!empty($widgets['site_menu'][0][2])) echo $widgets['site_menu'][0][2]->url; ?>"><? if(!empty($widgets['site_menu'][0][2])) echo $widgets['site_menu'][0][2]->title; ?></a></li>
                        <li><a href="/<? if(!empty($widgets['site_menu'][1][2])) echo $widgets['site_menu'][1][2]->url; ?>"><? if(!empty($widgets['site_menu'][1][2])) echo $widgets['site_menu'][1][2]->title; ?></a></li>
                        <li><a href="/<? if(!empty($widgets['site_menu'][1][7])) echo $widgets['site_menu'][1][7]->url; ?>"><? if(!empty($widgets['site_menu'][1][7])) echo $widgets['site_menu'][1][7]->title; ?></a></li>
                    </ul>
                </nav>
            </header>       