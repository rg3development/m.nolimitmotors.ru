...
<head>
    ...
    <script>
        ...
        function init() {
            ...
            $('.address').html(iteM[whatI][1] + '<br>' + 'тел.: <a class="tel" href="tel:' + iteM[whatI][2] + '">' + iteM[whatI][2] + '</a>' +
                '<br>' + '<a href="mailto:' + iteM[whatI][3] + '">' + iteM[whatI][3] + '</a>');
            //$('.tel').html(iteM[whatI][2]);
            $('#city_' + whatI).css({'display': ''});
            $('#telCity_' + whatI).html('тел.: <a class="tel" href="tel:' + iteM[whatI][2] + '">' + iteM[whatI][2] + '</a>' +
                '<br>' + '<a href="mailto:' + iteM[whatI][3] + '">' + iteM[whatI][3] + '</a>');
